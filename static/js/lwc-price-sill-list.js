...
(function ($lwc) {
    ...
    var profil = p.profil = {};
    profil.fav = 6.63;      // exprof 58 мм
    profil.bau = 10.76;      // KBE 58 мм
    profil.grain = 12.89;     // Grain Prestige 70 мм
 //   profil.rehau = 11.89;     // REHAU 58 мм
    ...
    f[$lwc.opentypes.rotary] = 40.45;           // поворотная для exprof
    f[$lwc.opentypes.rotaryfolding] = 49.03;    // поворотно-откидная для фаворита
    f = furn[$lwc.profiles.bau.name] = {};      // для баутека
    f[$lwc.opentypes.rotary] = 44.16;           // поворотная для KBE
