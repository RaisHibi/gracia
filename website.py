...
def picture_row(page_name, page_num, section, n):
    ...
    while pic_is == True:
        ...
        pic_code[str(page_counter)] = pic_code[str(page_counter)] + ' ' + '<a href="' + '/static/images/' + way + str(image_counter) + '.jpg" data-fancybox="images" class="col-sm-4"><img src="/static/images/'+ way + str(image_counter) + '.jpg" class="img-thumbnail"></a>'
